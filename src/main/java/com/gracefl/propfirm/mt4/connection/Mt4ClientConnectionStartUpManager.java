...
public class Mt4ClientConnectionStartUpManager {
	...
	//@Autowired
	//Mt4ClientConnectionTradeHistorySynchronizer mt4ClientConnectionTradeHistorySynchronizer;
    ...
    public void init() throws Exception {	
		...
		// MT4 trade synchronizer
		/*
    	log.info("Call MT4 Client Application for MT4 trade history");
        Thread pullThread = new Thread(mt4ClientConnectionTradeHistorySynchronizer);
        pullThread.start();
		*/
