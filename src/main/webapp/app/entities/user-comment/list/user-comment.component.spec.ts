...
describe('Component Tests', () => {
  describe('UserComment Management Component', () => {
    let comp: UserCommentComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(UserCommentComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.userComments[0]).toEqual(expect.objectContaining({ id: 123 }));
    });
