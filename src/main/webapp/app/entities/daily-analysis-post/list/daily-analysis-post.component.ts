...
export class DailyAnalysisPostComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.dailyAnalysisPostService
      ...
      .subscribe(
        (res: HttpResponse<IDailyAnalysisPost[]>) => {
  ...
  protected onSuccess(data: IDailyAnalysisPost[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
    this.totalItems = Number(headers.get('X-Total-Count'));
    this.page = page;
    if (navigate) {
      this.router.navigate(['/daily-analysis-post'], {
        queryParams: {
          page: this.page,
          size: this.itemsPerPage,
